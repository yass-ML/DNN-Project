...
class FaceNetInference:
    ...
    def __init__(self, model_path: str, embedding_dim: int = 128,
                 device: str = 'cuda', threshold: float = 1.0):
    ...
    @torch.no_grad()
    def get_embedding(self, image: Union[str, Path, Image.Image, np.ndarray]) -> np.ndarray:
        """
    ...
    def compute_distance(self, emb1: np.ndarray, emb2: np.ndarray,
    ...
    def compare_faces(self, image1: Union[str, Path, Image.Image],
        ...
        confidence = 1.0 - min(distance / (2 * self.threshold), 1.0) if is_same else \
                     min(distance / (2 * self.threshold), 1.0)
    ...
    def is_same_person(self, image1: Union[str, Path, Image.Image],
                       image2: Union[str, Path, Image.Image]) -> bool:
        """
    ...
    def find_matches(self, query_image: Union[str, Path, Image.Image],
...
def load_model(model_path: str, embedding_dim: int = 128,
               device: str = 'cuda') -> FaceNetInference:
    """
