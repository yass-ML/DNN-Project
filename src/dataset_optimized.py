...
class FaceDatasetOptimized(Dataset):
    ...
    - Faster image loading with cv2 or torchvision.io
    ...
    Args:
        ...
        use_fast_loader: Use cv2 or torchvision.io for faster loading
    """
    ...
    def __init__(
        ...
        self.use_fast_loader = use_fast_loader and (HAS_CV2 or HAS_TORCHVISION_IO)
    ...
    def _load_image_fast(self, path: str) -> Image.Image:
        ...
        if HAS_CV2:
            # OpenCV is typically 2-3x faster than PIL
            img = cv2.imread(path)
...
class IdentitySamplerOptimized(Sampler):
    ...
    def __init__(
        ...
        print(f"IdentitySamplerOptimized: {len(self.valid_identities)} valid identities, "
